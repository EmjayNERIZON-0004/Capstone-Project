...
<form action="{{route('awarenessQ')}}" method="POST">
@csrf <!-- CSRF protection token -->
    ...
    <div class="radio-container">
             <label>
                         <input type="radio" name="citizens_charter" value="yes" required>
                        Yes
                     </label>
                     <label>
                         <input type="radio" name="citizens_charter" value="no" required>
                         No
                     </label>
                 </div>   
...
<div class="progress-container">
    <span class="progress-text">Page 5 of 8</span>
    <div class="progress">
