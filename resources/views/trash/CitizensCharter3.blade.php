...
<body>
    ...
    <form action="{{route('usedQ')}}" method="POST">
@csrf <!-- CSRF protection token -->
    ...
    <label>
    <input   type="radio" name="citizen_charter"   value="Yes" required>
    Yes            
</label>
         <label>
...
<div class="progress-container">
    <span class="progress-text">Page 7 of 8</span>
    <div class="progress">
        <div class="progress-bar" style="width: 88%;"></div> <!-- Adjust width dynamically -->
    </div>
</div>
</div>
    </form>
